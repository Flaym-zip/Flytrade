...
'economic_head': ('Lecture economique auxiliaire', 'Booleen', "Toujours desactivee pendant l\'apprentissage scientifique H/S/B : aucune mise, aucun portefeuille, aucun multiplicateur n\'entre dans cette boucle. La tete economique n\'existe que dans le marche live, separement de ce protocole.", 'Champ verrouille a false; conserve pour compatibilite des anciens points de controle.'),
'dataset_id': ('Identifiant de dataset', 'UUID ou vide', "Selectionne le dataset importe explicitement utilise pour la separation TRAIN/VALIDATION/TEST. Deux imports Kraken distincts restent deux datasets distincts; vide, le seul dataset disponible pour la source est choisi automatiquement.", 'Plusieurs datasets disponibles sans choix explicite : le protocole refuse de demarrer.'),
